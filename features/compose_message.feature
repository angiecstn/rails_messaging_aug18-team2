...
Scenario: Happy path composing a message
    ...
    And "Kanin" should have message from "Kalle"
    And the message should have subject "Hej Kanin"
    And the message should have body "Give me back my Carrots!"
 
Scenario: Sad path composing a message
  Given I am on the inbox page
    When I click on the link "Compose"
    Then I am on the compose page
    And show me the page
    And I pick "Kanin" 
    And I click on the link "Send Message"
    Then I should see the message "You need to provide both Subject and Message in order to send."
    And show me the page